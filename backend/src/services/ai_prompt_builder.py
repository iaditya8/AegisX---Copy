...
class AIPromptBuilder:
    ...
    def build_asset_prompt(cls, context: Dict[str, Any]) -> str:
        ...
        return (
            ...
            "mutate alert states, mutate incident/investigation states, or mutate case states, evidence, or custody chains "
            "(you are physically blocked from creating, updating, assigning, closing, resolving, or suppressing alerts; "
            "creating, updating, assigning, triaging, containing, resolving, or closing incidents and investigations; and "
