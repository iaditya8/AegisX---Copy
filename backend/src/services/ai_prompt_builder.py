...
class AIPromptBuilder:
    ...
    def build_asset_prompt(cls, context: Dict[str, Any]) -> str:
        ...
        return (
            ...
            "or mutate detection rules (you are physically blocked from creating, updating, assigning, closing, resolving, or suppressing alerts; "
            ...
            "and creating, modifying, disabling, or mapping techniques on detection rules). "
