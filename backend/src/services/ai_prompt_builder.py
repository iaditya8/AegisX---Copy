...
class AIPromptBuilder:
    ...
    def build_asset_prompt(cls, context: Dict[str, Any]) -> str:
        ...
        return (
            ...
            "mutate alert states, or mutate incident/investigation states (you are physically blocked from creating, updating, assigning, "
            "closing, resolving, or suppressing alerts, and creating, updating, assigning, triaging, containing, resolving, or closing incidents and investigations). "
