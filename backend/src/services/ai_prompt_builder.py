...
class AIPromptBuilder:
    ...
    def build_asset_prompt(cls, context: Dict[str, Any]) -> str:
        ...
        return (
            ...
            "or mutate alert states (you are physically blocked from creating, updating, assigning, closing, resolving, or suppressing alerts). "
            "Do not generate, suggest, or speculate on any custom remediation actions, governance statuses, alerts, or "
    ...
    def build_executive_prompt(cls, context: Dict[str, Any]) -> str:
        ...
        return (
            ...
            "However, you MUST NOT approve risk, revoke risk, modify governance state, make compliance decisions, "
            "or mutate alert states (you are physically blocked from creating, updating, assigning, closing, resolving, or suppressing alerts). "
            "Do not generate, suggest, or speculate on any risk ratings, priority metrics, alerts, or rankings that are not "
