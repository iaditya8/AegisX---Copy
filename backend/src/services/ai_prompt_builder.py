...
class AIPromptBuilder:
    ...
    def build_asset_prompt(cls, context: Dict[str, Any]) -> str:
        ...
        return (
            ...
            "mutate detection rules, or mutate threat intelligence data (you are physically blocked from creating, updating, assigning, closing, resolving, or suppressing alerts; "
            ...
            "creating, modifying, disabling, or mapping techniques on detection rules; and creating, modifying, expiring, revoking, or correlating IOCs, threat actors, campaigns, or correlations). "
