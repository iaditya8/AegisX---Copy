...
class AIPromptBuilder:
    ...
    def build_asset_prompt(cls, context: Dict[str, Any]) -> str:
        ...
        return (
            ...
            "and creating compliance assessments, transitioning compliance status, or mapping GRC frameworks; "
            "and creating security knowledge items, playbooks, relationships, or recommendations). "
